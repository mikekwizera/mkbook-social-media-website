    ...
    <AuthenticatedLayout>
        <div class="max-w-[768px] mx-auto h-full overflow-auto">
            ...
            <div class="group relative bg-white">
                <img :src="coverImageSrc || user.cover_url || '#'"
            ...
            <div class="border-t">
                <TabGroup>
                    <TabList class="flex bg-white">
                        ...
                        <Tab v-if="setting" v-slot="{ selected }" as="template">
                            <TabItem text="Setting" :selected="selected"/>
                        </Tab>
                    </TabList>
...
const setting = computed(() => authUser && authUser.id === props.user.id)
